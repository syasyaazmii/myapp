...
<!-- line 26 dalam main.php -->
<!-- define layout tu main, dalam main ada area -->
...
<?php $this->stop() ?>
<!-- define bahagian main area habis dekat sini, if ada sidebar/navbar, perlu ada yg lain pula -->
<!-- main area end -->
